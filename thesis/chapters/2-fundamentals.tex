...
\section{Geospatial data}
	...
	Geodata with an additional time dimension is also categorized as \term{spatiotemporal data}\cite{iso-19108} and even though the time dimension is relevant to many reals world use cases, this type of data is of less importance for this thesis as well.
