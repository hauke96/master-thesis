...
\section{Geospatial data}
	...
	\label{subsec:file-formats}
		...
		\label{subsubsec:shapefile}
			...
			Shapefiles are very popular\cite[3]{spatial-file-formats-trends} but have several significant technical limitations regarding the containing geometries and attributes.
