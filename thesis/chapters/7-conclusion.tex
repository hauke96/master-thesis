...
%			\vspace{-0.5\baselineskip}
	...
	\subsection{Additional functionalities}
		...
		Approaches exist to reduce the number of edges in a routing graph with little effect on the route quality \cite{aumann-reducing-routing-graph}, which will speed up graph generation and routing.
