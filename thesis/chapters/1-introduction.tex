...
\section{Motivation}
	...
	In other words, all paths from the source to any location inside one region go from the source via other vertices to that predecessor and from there directly to the destination location.
