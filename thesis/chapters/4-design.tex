...
\label{sec:combining-routing-algorithms}
	...
	\subsection{Ad hoc generation of edges}
		...
		Whenever the graph routing algorithm reaches a road junction, it's pauses and the \term*[continuous Dijkstra paradigm]{continuous Dijkstra} algorithm is started.
