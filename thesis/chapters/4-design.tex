...
\label{sec:design-decisions}
	...
	\subsection{Decision against scientific approaches}
		...
		\subsubsection{Suitability of existing approaches}
			...
			Even though it would probably not be a significant effort, implementing an algorithm for this task would be needed, e.g. the algorithm presented by \todo{TRIANGULATING A REGION BETWEEN ARBITRARY POLYGONS}, in addition to the visibility graph creation itself.
	
	\subsection{Data structure design}
	% TODO own section? What type of architecture view? With class diagrams?
