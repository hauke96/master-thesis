...
\section{Routing}
	...
	\subsection{Graph based routing}
		...
		\subsubsection{Transit nodes}
			...
			This routing technique uses specially selected vertices, so called \term[transit node]{transit nodes}, and a the distances between them and all other vertices to find shortest paths very quickly \cite{bast-transit}.
