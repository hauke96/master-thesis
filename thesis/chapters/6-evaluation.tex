...
%					\begin{figcenter}
%						\input{images/evaluation/osm-based-city/plot-import-details-per-vertices.py_relative.pgf}
%					\end{figcenter}
...
%				\begin{subfigure}[t]{.48\textwidth}
%					\begin{figcenter}
%						\input{images/evaluation/osm-based-rural/plot-import-details-per-vertices.py_relative.pgf}
%					\end{figcenter}
%					\caption{Relative share of each task on the total import time.}
%				\end{subfigure}
			\end{figcenter}
