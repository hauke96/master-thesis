...
Total time			& 963.1		& 535.29	& 44.42\%						& 1.43			& 99.85\%
			...
			\Cref{fig:eval-import-osm-no-roads-obstacles-city} lists and illustrates the comparison of the results for the \enquote{OSM city} datasets with two noteworthy insights:
			\begin{itemize}
...
Total time			& 21,658	& 8709		& 59.79\%						& 39.7			& 99.82\%
			...
			\Cref{fig:eval-import-osm-no-roads-obstacles-rural} lists and illustrates the comparison of the results for the \enquote{OSM rural} datasets.
			\begin{itemize}
