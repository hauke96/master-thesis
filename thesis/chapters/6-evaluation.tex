		...
		\subsubsection{Routing}
			...
			\begin{minipage}{\textwidth}
				...
				\begin{minipage}[t]{0.56\textwidth}
					\captionof{figure}{The first and fifth routing requests (red arrow between source and destination) with the nearby obstacles (gray). Visibility edges of the two destination vertices are shown in blue and green.}
