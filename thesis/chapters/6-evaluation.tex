...
\bottomrule
	...
	\subsection{Optimizations}
		...
		The impact of the optimizations presented in \Cref{chap:implementation} was measured using the 0.5km\textsuperscript{2} \enquote{OSM city} dataset as listed in \Cref{table:optimization-impact}.
		...
		Considering an implementation without any optimizations, activating all of them should, according to the speedup factors on the right side of \Cref{table:optimization-impact}, result in a speedup of over 255 but only 71 can be observed.
...
\section{Route correctness and quality}
	...
	\subsection{Quality of routes}
		...
		\subsubsection{Route quality definition and determination}
			...
			The similarity between an actual calculated route and an expected route can be quantified using certain mathematical metrics, which are used in a second quality analysis.
...
%				\vspace{-0.55\baselineskip}
			...
			Comparing route lengths only yields a vague indication of the route's quality.
