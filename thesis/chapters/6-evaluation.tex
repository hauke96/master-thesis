...
\section{Performance evaluation}
	...
	\subsection{OSM-based datasets}
		...
		\subsubsection{Routing}
			...
			However, the A* algorithm in both OSM-based categories takes longer for longer routes.
	...
	\subsection{Quality of routes}
		...
		\label{subsubsec:manual-route-analysis}
			...
			\begin{itemize}
				...
				\Cref{fig:eval-city-weights} illustrates this with different preferences on road edges.
		...
		\subsubsection{Mathematical route quality analysis}
			...
			\begin{wrapfigure}{r}{0.35\textwidth}
				\begin{figcenter}
					\input{images/tikz-hausdorff.tex}
				\end{figcenter}
