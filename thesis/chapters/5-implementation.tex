...
\section{Data structures}
	...
	\label{subsec:shadow-areas}
		...
		\begin{figure}[h]
			\begin{figcenter}
				\input{images/tikz-shadow-areas.tex}
			\end{figcenter}
	...
	\label{subsec:binindex}
		...
		\begin{figure}[h]
			\begin{figcenter}
				\input{images/tikz-bin-index.tex}
			\end{figcenter}
...
\label{sec:visibility-graph-creation}
	...
	\label{subsec:step-2-knn-search}
		...
		\label{subsubsec:valid-angle-areas}
			...
			\begin{figure}[h]
				\begin{figcenter}
					\input{images/tikz-valid-angle-area.tex}
				\end{figcenter}
		...
		\label{subsubsec:intersection-checks}
			...
			\begin{figure}[h]
				\begin{figcenter}
					\input{images/tikz-barycentric-coordinates.tex}
				\end{figcenter}
		...
		\subsubsection{Step 2.1: Determining obstacle neighbors}
			...
			\begin{figure}[h]
				\begin{minipage}[t]{0.475\textwidth}
					\begin{figcenter}
						\input{images/tikz-obstacle-neighbors-line.tex}
					\end{figcenter}
				...
				\begin{minipage}[t]{0.475\textwidth}
					\begin{figcenter}
						\input{images/tikz-obstacle-neighbors-polygon.tex}
					\end{figcenter}
		...
		\label{subsubsec:sort-visibility-neighbors}
			...
			\begin{figure}[h]
				\begin{figcenter}
					\begin{subfigure}[t]{.48\textwidth}
						\begin{figcenter}
							\input{images/tikz-vertex-creation-naive.tex
							}
						\end{figcenter}
					...
					\begin{subfigure}[t]{.48\textwidth}
						\begin{figcenter}
							\input{images/tikz-vertex-creation-correct.tex}
						\end{figcenter}
			...
			\begin{figure}[h]
				\begin{figcenter}
					\input{images/tikz-visibility-neighbor-bins.tex}
				\end{figcenter}
	...
	\label{subsec:step-3-graph-creation}
		...
		\begin{figure}[h]
			\begin{figcenter}
				\input{images/tikz-connecting-neighbor-bins.tex}
			\end{figcenter}
