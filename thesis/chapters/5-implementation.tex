		...
		\begin{figure}[h]
			\begin{figcenter}
				\begin{tikzpicture}
					...
					% Item A: Bins 1-5
					\filldraw[pattern=north west lines,pattern color=red] (\itemBStartX*\l,\countY+4*\l) rectangle node[above right=0.125 and -1.3]{Item B: \itemBStartX\ - 5.7} ++(\itemBLength*\l,0.5*\l);
