...
%						\item Create and store the shadow area for each of these obstacles.
%						\item Check if $u$ is a visibility neighbor, which is true if a) $u$ is still not in any shadow area and b) the line segment from $v$ to $u$ intersects with none of the above queries obstacles.
%					\end{enumerate}
%				\end{enumerate}
