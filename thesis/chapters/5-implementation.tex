...
\section{Data structures}
	...
	\label{subsec:binindex}
		...
		Items are added to all bins intersecting with the range of the item, therefore each bin is a linked list.
		...
		\begin{wraptable}[7]{r}{8.25cm}
			\vspace{-1.5\baselineskip}
			\begin{tabularx}{\linewidth}{>{\raggedleft}X|rr|rr}
\centering\textbf{Intervals /}	& \multicolumn{2}{c|}{\textbf{\texttt{BinIndex}}}				& \multicolumn{2}{c}{\textbf{\texttt{Bintree}}}			\\
\centering\textbf{queries}		& \multicolumn{1}{c}{Insert}	& \multicolumn{1}{c|}{Query}	& \multicolumn{1}{c}{Insert}	& \multicolumn{1}{c}{Query}	\\
\hline
1,000							& 0.003s						&  0.018ms						&   0.22ms						& 0,04s						\\
100,000							& 0.89s							&  0.7ms						&  21.6ms						& 135s						\\
200,000							& 2.14s							&  1.69ms						&  60.6ms						& 597s						\\
			\end{tabularx}
			\caption{Comparison of the custom \texttt{BinIndex} and the NTS \texttt{Bintree}.}
