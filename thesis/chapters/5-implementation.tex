	...
	\subsection{Step 2: Determining $k$ nearest visible neighbors}
			...
			\subsubsection{Shadow areas}
				...
				\begin{figure}[h]
					\begin{center}
						\begin{tikzpicture}
							\filldraw[lightgray] (3.25,0.6875) -- (3.25,2.3125) -- (6,3) -- (6,0) -- cycle;
							\filldraw[draw=none,lightgray,path fading=east] (7,3.25) -- (6,3) -- (6,0) -- (7,-0.25) -- cycle;
							\draw[gray] (6,3) -- (3.25,2.3125) -- (3.25,0.6875) -- (6,0);
							...
							\draw[dotted] (v) -- (3.25,2.3125);
							\draw[dotted] (v) -- (3.25,0.6875);
						\end{tikzpicture}
					\end{center}
					\caption{Shadow area $S$ cast by obstacle $o_1$ for vertexy $v$. The vertex $v'$ of obstacle $o_2$ is not visible from $v$ since it lies inside the shadow area.}
				\end{figure}
