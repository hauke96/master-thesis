...
\section{Graph generation}
	...
	\subsection{Enhancing existing graphs}
		...
		Edges not relevant for paths through the plaza are removed afterwards.\todo[inline]{Im paper "of Bungiu et al. [ 7]" nachschauen}
	...
	\subsection{Crowd sourced graph generation}
		...
		% https://www.researchgate.net/profile/Jincai-Huang-2/publication/345771914_A_Pedestrian_Network_Construction_System_Based_on_Crowdsourced_Walking_Trajectories/links/609411bea6fdccaebd11ca67/A-Pedestrian-Network-Construction-System-Based-on-Crowdsourced-Walking-Trajectories.pdf
	
		% https://sci-hub.ru/https://doi.org/10.1016/j.trc.2012.09.007
