...
\begin{document}
	...
	\section{Motivation}
		...
		% TODO eher das actual result zeigen
		...
		\begin{frame}{Graph generation task performance}
			\begin{figure}
				\begin{figcenter}
					...
					\scalebox{0.7}
					{
						\input{images/osm-city_plot-import-details-per-vertices.py_absolute.pgf}
					}
				\end{figcenter}
		...
		\begin{frame}{Memory usage}
			\begin{figure}
				\begin{figcenter}
					...
					\scalebox{0.7}
					{
						\input{../thesis/images/evaluation/osm-based-city/plot-memory-usage.py_osm-based-city-4km2.pgf}
					}
				\end{figcenter}
		...
		\begin{frame}{Hausdorff distances of routes}
			\begin{figure}
				\begin{figcenter}
					\scalebox{0.66}
					{
						\input{../thesis/images/evaluation/similarity-metric/plot.py_osm-city_hausdorff.pgf}
					}
					\scalebox{0.66}
					{
						\input{../thesis/images/evaluation/similarity-metric/plot.py_osm-rural_hausdorff.pgf}
					}
				\end{figcenter}
	...
	\begin{frame}{Graph generation task performance}
		\begin{figure}
			\begin{figcenter}
				...
				\scalebox{0.7}
				{
					\input{images/osm-city_plot-import-details-per-vertices.py_relative.pgf}
				}
			\end{figcenter}
	...
	\begin{frame}{Graph generation task performance}
		\begin{figure}
			\begin{figcenter}
				...
				\scalebox{0.7}
				{
					\input{images/osm-rural_plot-import-details-per-vertices.py_absolute.pgf}
				}
			\end{figcenter}
			\caption{Time of graph generation tasks on all \enquote{OSM rural} datasets.}
		\end{figure}
	...
	\begin{frame}{Graph generation task performance}
		\begin{figure}
			\begin{figcenter}
				...
				\scalebox{0.7}
				{
					\input{images/osm-rural_plot-import-details-per-vertices.py_relative.pgf}
				}
			\end{figcenter}
			\caption{Time of graph generation tasks on all \enquote{OSM rural} datasets.}
		\end{figure}
