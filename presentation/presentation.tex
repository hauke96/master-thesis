...
%		\end{frame}
	...
	\section{Implementation}
		...
		\begin{frame}{Visibility graph creation: vertex and edge creation}
			\begin{itemize}
				\item naive vertex creation: one vertex per input coordinate
				\begin{itemize}
					\item problem: routing through line-based obstacles possible
				\end{itemize}
				\pause
				\item correct vertex creation: one vertex between each neighbor vertices on the obstacle
				\begin{itemize}
			...
			\begin{figure}[b]
				\begin{figcenter}
					\includegraphics[scale=0.75]{images/thesis-figure7.pdf}
					\hspace{0.75cm}
					\includegraphics[scale=0.75]{images/thesis-figure8.pdf}
				\end{figcenter}
